 ...
 <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex justify-cntent-center align-items-center">
    <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
      ...
      <!-- Slide 3 -->
      <div class="carousel-containeritem">
        <div class="carousel-container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up">
            <div class="icon-box icon-box-pink">
              <img src="<?php echo base_url('assets/img/Digital_marketing.jpg');?>" style="height:150px; width:180px">
              <h4 class="title"><a href="">Digital Marketing</a></h4>
                <a href="<?php echo site_url('Main_controller/Services_view_controller');?>" class="btn-get-started animate__animated animate__fadeInUp">Read More</a>
            </div>
          </div>

          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box icon-box-cyan">
               <img src="<?php echo base_url('assets/img/web_designing.jpg');?>" style="height:150px;width:180px">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box icon-box-green">
               <img src="<?php echo base_url('assets/img/web_development.jpg');?>" style="height:150px;width:180px">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box icon-box-blue">
              <img src="<?php echo base_url('assets/img/Mobile_app.jpg');?>" style="height:150px;width:180px">
